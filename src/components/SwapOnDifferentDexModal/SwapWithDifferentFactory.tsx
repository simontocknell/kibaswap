...
export const SwapTokenForTokenWithFactory = (props: TokenForTokenProps) => {
    ...
    const onCurrencyInputSelect = handleInputSelect
    const onCurrencyOutputSelect = handleOutputSelect
